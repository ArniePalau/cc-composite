...
final class AtlasMapCache
{
    ...
    private const int CACHE_ZOOM = 4;
    ...
    public function cache(string $world): MapCacheResult
    {
        ...
        // Keep the zoom in the filename so an upgraded plugin does not reuse a
        // lower-resolution map generated by an earlier release.
        $zoom = min(self::CACHE_ZOOM, $maxZoom);
        $path = sprintf('maps/%s-z%d.png', $slug, $zoom);
